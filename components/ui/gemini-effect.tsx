...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-80", className)}>
            <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-neutral-950">
                {title || `Masaar`}
            </p>
            <p className="text-xs md:text-xl font-normal text-center text-neutral-700 mt-4 max-w-lg mx-auto">
                {description ||
                    `Embark on a Journey of Success with Masaar – Your Personal Navigator, Harnessing the Power of AI to Tailor Guidance and Illuminate Your Path to Success.`}
            </p>
