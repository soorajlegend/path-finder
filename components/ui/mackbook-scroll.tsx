  ...
  return (
    ...
    >
      ...
      >
        {title || (
          <h1>
            <span className="text-6xl font-bold">Masaar</span>
            <br />
            Your AI-Powered Navigator to Success.
          </h1>
        )}
      </motion.h2>
      {/* Lid */}
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-full max-w-7xl mx-auto bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
